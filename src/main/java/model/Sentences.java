 ...
 * XML source: /Users/lpq1990/Documents/workspace/11791/hw1-pengqil/src/main/resources/descriptors/ner/GeneTagTrainDescriptor.xml
 * @generated */
public class Sentences extends Annotation {
  ...
  public String getId() {
    if (Sentences_Type.featOkTst && ((Sentences_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "model.Sentences");
  ...
  public String getText() {
    if (Sentences_Type.featOkTst && ((Sentences_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "model.Sentences");
